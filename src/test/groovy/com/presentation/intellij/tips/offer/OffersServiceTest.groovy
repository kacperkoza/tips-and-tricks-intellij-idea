...
class OffersServiceTest extends Specification {
    ...
    def "should throw UnauthorizedOfferModificationException when user tries to modify another users offer"() {
        given:
    ...
    def "should search offers with various criteria: #testDescription"() {
        ...
        "query search for Gaming" | "Gaming" | null                 | null                  | null                  | null               | SortBy.CREATED_DESC                                             | 20    | 0      | 1
        ...
        "all offers default"      | null     | null                 | null                  | null                  | null               | com.presentation.intellij.tips.offer.search.SortBy.CREATED_DESC | 20    | 0      | 5
        ...
        "limit and offset 10,0"   | null     | null                 | null                  | null                  | null               | com.presentation.intellij.tips.offer.search.SortBy.CREATED_DESC | 10    | 0      | 5
    ...
    private static Offer offer() {
        return new Offer(
                ...
                "descrption".repeat(5),                  // description (20+ chars)
